...
func _ready():
	...
	%DoneButton.visible = RhythmGameSignals.final_score > 32000

func _on_play_again_pressed():
	RhythmGameSignals.final_score = 0
	RhythmGameSignals.best_combo = 0
	get_tree().change_scene_to_file("res://Scenes/rhythm game/rhythm_game_level_silent_acropolis.tscn")
...
func _on_done_pressed():
	RhythmGameSignals.final_score = 0
	RhythmGameSignals.best_combo = 0
	get_tree().change_scene_to_file("res://Scenes/text game/grief_route.tscn")
